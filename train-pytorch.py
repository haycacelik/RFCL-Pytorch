...
from rfcl.agents.sac.sac_pytorch import SAC, SACConfig
...
from rfcl.models import NetworkConfig, build_network_from_cfg #has jax, only right
...
def main(cfg: SACExperiment):
    ...
    algo = SAC(
        ...
        cfg=cfg.sac,
        offline_buffer=demo_replay_dataset if cfg.train.train_on_demo_actions else None,
