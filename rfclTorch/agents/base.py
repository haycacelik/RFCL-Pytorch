...
import gymnasium 
from rfclTorch.data.loop import (
    BaseEnvLoop,
    DefaultTimeStep,
    EnvAction,
    EnvObs,
...
from rfclTorch.logger.logger import Logger, LoggerConfig
from rfclTorch.utils.spaces import get_action_dim, get_obs_shape
from rfclTorch.utils.tools import tree_map
...
class BasePolicy:
    def __init__(
        ...
        self.jax_env = False#Hardcoded this to false for now, eventually remove and clean up dependencies
    ...
    def evaluate(
        ...
        apply_fn: nn.Module,#getting the actor module here!
